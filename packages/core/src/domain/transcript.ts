...
export function createTranscriptChunk(
  ...
  return {
    ...
    prosodyEnergy: input.prosodyEnergy ?? null,
    prosodyPauseRatio: input.prosodyPauseRatio ?? null,
    prosodyVoicedMs: input.prosodyVoicedMs ?? null,
    prosodySnrDb: input.prosodySnrDb ?? null,
    prosodyQualityPass: input.prosodyQualityPass ?? null,
    prosodyToneWeightsEnabled: input.prosodyToneWeightsEnabled ?? null,
    prosodyConfidencePenalty: input.prosodyConfidencePenalty ?? null,
    prosodyClientEnergy: input.prosodyClientEnergy ?? null,
    prosodyClientStress: input.prosodyClientStress ?? null,
    prosodyClientCertainty: input.prosodyClientCertainty ?? null,
    text: input.text,
